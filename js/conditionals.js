...
//
// alert('Yes, ' + analyzeColor(userFavColor));
//
// /* ########################################################################## */
//
// /**
...
//     return total - ((yourLuckyNumber * .01) * total);
// }
//
...
//
// var askCust = prompt('What was your total bill?');
//
...
// (parseInt(qTwo) % 2 === 1 && custQ === true) ? alert('This is an odd number!') : false;
